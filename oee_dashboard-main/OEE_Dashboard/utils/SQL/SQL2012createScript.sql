...
IF OBJECT_ID('dbo.LINE_SCHEDULES', 'U') IS NOT NULL DROP TABLE dbo.LINE_SCHEDULES;
GO
...
GO
CREATE TABLE [dbo].[LINE_SCHEDULES]( [id] [int] IDENTITY(1,1) NOT NULL, [line] [varchar](50) NOT NULL, [shift_name] [varchar](50) NOT NULL, [start_time] [time](7) NOT NULL, [end_time] [time](7) NOT NULL, [planned_break_minutes] [int] NOT NULL, [is_active] [bit] NOT NULL, CONSTRAINT [PK_LINE_SCHEDULES] PRIMARY KEY CLUSTERED ([id] ASC));
GO
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_line_shift] ON [dbo].[LINE_SCHEDULES] ([line] ASC, [shift_name] ASC);
GO
...
-- This section inserts default data for LINE_SCHEDULES.
-- ====================================================================================================================
PRINT 'Seeding initial data for LINE_SCHEDULES...';
GO

BEGIN
    -- This logic checks if a schedule for a given line and shift already exists before inserting.
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'ASSEMBLY' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Assembly'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);
    
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'ASSEMBLY' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Assembly'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'PAINT' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Paint'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);
        
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'PAINT' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Paint'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'SPOT' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Spot'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);
        
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'SPOT' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Spot'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'BEND' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Bend'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);
        
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'BEND' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Bend'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'PRESS' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Press'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);
        
    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'PRESS' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('Press'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'LASER CUTTING' AND shift_name = 'DAY')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('LASER CUTTING'), UPPER('Day'), '08:00:00', '20:00:00', 90, 1);

    IF NOT EXISTS (SELECT 1 FROM dbo.LINE_SCHEDULES WHERE line = 'LASER CUTTING' AND shift_name = 'NIGHT')
        INSERT INTO dbo.LINE_SCHEDULES (line, shift_name, start_time, end_time, planned_break_minutes, is_active) VALUES (UPPER('LASER CUTTING'), UPPER('Night'), '20:00:00', '08:00:00', 90, 1);
END
GO
PRINT 'LINE_SCHEDULES data seeded successfully.';
GO
